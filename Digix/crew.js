    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                ...
                const messageText = `
╔══════════════════╗
      *Rahib King MD Connected Successfully* 🚀
╠══════════════════╣
> "Always Forward. Rahib King MD, one of the best."
╚══════════════════╝
...
*Rahib King MD 243*
                ...
                await sock.sendMessage(chatId, {
                    image: { url: imagePath },
                    caption: messageText,
                    footer: '💻 Powered by Rahib King MD',
                });
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const code = await sock.requestPairingCode(number, 'RAHİBKMD');
