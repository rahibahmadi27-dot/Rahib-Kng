...
export async function antilink(client, message) {
    ...
    try {
        ...
        if (!action) {
            const usage = `🔒 *Rahib King MD - Antilink*\n\n.antilink on\n.antilink off\n.antilink set delete | kick | warn\n.antilink status`
...
export async function kickall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '⚡Rahib King MD - Purge...' })
...
export async function kickall2(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '⚡ Rahib King MD - One Shot...' })
